...
public:
    ...
    void backtrack_1(vector<vector<string>> &solutions, vector<int> &queens, int n, int row, unordered_set<int> &columns,
                     unordered_set<int> &diagonals1, unordered_set<int> &diagonals2)
    {
        ...
        else
        {
            for (int i = 0; i < n; i++)
            {
                ...
                backtrack_1(solutions, queens, n, row + 1, columns, diagonals1, diagonals2);
